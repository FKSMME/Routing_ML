...
export RSL_DATABASE_URL=${RSL_DATABASE_URL:-"postgresql+psycopg://postgres:postgres@localhost:5432/routing_ml"}
export ROUTING_GROUPS_DATABASE_URL=${ROUTING_GROUPS_DATABASE_URL:-"postgresql+psycopg://postgres:postgres@localhost:5432/routing_ml"}
export MODEL_REGISTRY_URL=${MODEL_REGISTRY_URL:-"postgresql+psycopg://postgres:postgres@localhost:5432/routing_ml"}
