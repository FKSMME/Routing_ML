...
export function AlgorithmWorkspace() {
  ...
  const pushSnapshot = useWorkflowGraphHistory((state) => state.pushSnapshot);
  const undo = useWorkflowGraphHistory((state) => state.undo);
  const redo = useWorkflowGraphHistory((state) => state.redo);
  const canUndo = useWorkflowGraphHistory((state) => state.canUndo);
  const canRedo = useWorkflowGraphHistory((state) => state.canRedo);
  const reset = useWorkflowGraphHistory((state) => state.reset);
