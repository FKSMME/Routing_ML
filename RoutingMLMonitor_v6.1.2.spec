...
# PyInstaller spec file for Routing ML Monitor v6.1.2
# Modularized version using monitor package
# Optional authentication - no popup on startup, shows friendly message instead
