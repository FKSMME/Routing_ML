...
# PyInstaller spec file for Routing ML Monitor v6.1.1
# Modularized version using monitor package
# Optional authentication - no longer requires admin credentials for basic features
