...
const Ballpit = ({ className = '', followCursor = true, count = 100, gravity = 0.7, friction = 0.8, wallBounce = 0.95, colors, ...props }: BallpitProps) => {
  ...
  }, [followCursor, count, gravity, friction, wallBounce, colors, props]);
